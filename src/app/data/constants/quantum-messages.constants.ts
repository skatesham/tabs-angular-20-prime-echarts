export type QuantumMessagesByDay = readonly [
  readonly string[], // Domingo
  readonly string[], // Segunda
  readonly string[], // Terça
  readonly string[], // Quarta
  readonly string[], // Quinta
  readonly string[], // Sexta
  readonly string[]  // Sábado
];

export const QUANTUM_MESSAGES: QuantumMessagesByDay = [
  // Domingo - Renovação
  [
